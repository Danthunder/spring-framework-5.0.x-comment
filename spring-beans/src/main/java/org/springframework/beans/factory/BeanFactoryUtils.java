...
public abstract class BeanFactoryUtils {
	 ...
	 *
	 * 类似 ClassLoader 类加载的双亲委派机制，先从 ParentBeanFactory 中获取 Class<T> type
	 * 的 Bean 放入缓存 result:Map 中，当 ChildBeanFactory 中发现相同 Class<T> type 类型
	 * 的 Bean 不放入缓存 result:Map 中。
	 */
